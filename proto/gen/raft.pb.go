...
type LogEntry struct {
	...
	Index   int32  `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty"`    // Index of new entry (should be prevLogIndex + 1)
	Command string `protobuf:"bytes,3,opt,name=command,proto3" json:"command,omitempty"` // Command for the state machine
}
...
func (x *ClientRequestAck) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClientRequestAck) ProtoMessage() {}

func (x *ClientRequestAck) ProtoReflect() protoreflect.Message {
	mi := &file_proto_raft_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClientRequestAck.ProtoReflect.Descriptor instead.
func (*ClientRequestAck) Descriptor() ([]byte, []int) {
	return file_proto_raft_proto_rawDescGZIP(), []int{6}
}

func (x *ClientRequestAck) GetInProgress() bool {
	if x != nil {
		return x.InProgress
	}
	return false
...
type ClientRequestCompletion struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *ClientRequestCompletion) Reset() {
	*x = ClientRequestCompletion{}
	mi := &file_proto_raft_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClientRequestCompletion) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClientRequestCompletion) ProtoMessage() {}

func (x *ClientRequestCompletion) ProtoReflect() protoreflect.Message {
	mi := &file_proto_raft_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClientRequestCompletion.ProtoReflect.Descriptor instead.
func (*ClientRequestCompletion) Descriptor() ([]byte, []int) {
	return file_proto_raft_proto_rawDescGZIP(), []int{7}
}

func (x *ClientRequestCompletion) GetRequestId() string {
	if x != nil {
		return x.RequestId
	}
	return ""
...
var file_proto_raft_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x72, 0x61, 0x66, 0x74, 0x1a, 0x1b, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65,
	0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x65, 0x6d, 0x70, 0x74, 0x79, 0x2e,
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x43, 0x0a, 0x0b, 0x56, 0x6f, 0x74, 0x65, 0x52, 0x65, 0x71,
	...
	0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0x65, 0x49, 0x64, 0x22, 0x44, 0x0a, 0x0c, 0x56, 0x6f,
	...
	0x22, 0xda, 0x01, 0x0a, 0x14, 0x41, 0x70, 0x70, 0x65, 0x6e, 0x64, 0x45, 0x6e, 0x74, 0x72, 0x69,
	...
	0x6d, 0x61, 0x6e, 0x64, 0x22, 0x29, 0x0a, 0x0d, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65,
	...
	0x32, 0x0a, 0x10, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x41, 0x63, 0x6b, 0x12, 0x1e, 0x0a, 0x0a, 0x69, 0x6e, 0x50, 0x72, 0x6f, 0x67, 0x72, 0x65, 0x73,
	0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0a, 0x69, 0x6e, 0x50, 0x72, 0x6f, 0x67, 0x72,
	0x65, 0x73, 0x73, 0x22, 0x37, 0x0a, 0x17, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x43, 0x6f, 0x6d, 0x70, 0x6c, 0x65, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x1c,
	0x0a, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x09, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x32, 0xc4, 0x01, 0x0a,
	...
	,
	...
	0x67, 0x65, 0x6e, 0x50, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_raft_proto_goTypes = []any{
	...
	(*ClientRequestAck)(nil),        // 6: raft.ClientRequestAck
	(*ClientRequestCompletion)(nil), // 7: raft.ClientRequestCompletion
...
var file_proto_raft_proto_depIdxs = []int32{
	...
	5, // 3: raft.Raft.ClientGateway:input_type -> raft.ClientRequest
	7, // 4: raft.Client.ClientNotification:input_type -> raft.ClientRequestCompletion
	1, // 5: raft.Raft.RequestVote:output_type -> raft.VoteResponse
	3, // 6: raft.Raft.AppendEntries:output_type -> raft.AppendEntriesResponse
	6, // 7: raft.Raft.ClientGateway:output_type -> raft.ClientRequestAck
	8, // 8: raft.Client.ClientNotification:output_type -> google.protobuf.Empty
